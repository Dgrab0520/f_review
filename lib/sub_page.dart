  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0,
        title: Center(child: Image.asset('assets/logo.png',width: 40,)),
        leading: Container(
            padding: EdgeInsets.only(left:10),
            child: Image.asset('assets/menu.png',)),leadingWidth: 35,
        actions: [
          Container(
                    ...
                    Row(
                      children: [
                        Expanded(
                          flex:9,
                          child: Container(
                            padding:EdgeInsets.only(left:20,right:5,bottom:5),
                            width:Get.width,
                            height:45,
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _areaPressed ? Colors.white : Color(0xFF362C5E),
                                // 2
                                color: _areaPressed ? Color(0xFF362C5E) : Colors.white,
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _areaPressed2 ? Colors.white : Color(0xFF362C5E),
                                // 2
                                color: _areaPressed2 ? Color(0xFF362C5E) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFF362C5E)),
                                ),
                            ...
                            child: SizedBox(
                              ...
                              child: InkWell(
                                ...
                                child: RaisedButton(
                                  ...
                                  elevation: 0,
                                  textColor: _areaPressed3 ? Colors.white : Color(0xFF362C5E),
                                  // 2
                                  color: _areaPressed3 ? Color(0xFF362C5E) : Colors.white,
                                  shape: RoundedRectangleBorder(
                                    borderRadius: new BorderRadius.circular(20.0),
                                    side: BorderSide(color: Color(0xFF362C5E)),
                                  ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _areaPressed4 ? Colors.white : Color(0xFF362C5E),
                                // 2
                                color: _areaPressed4 ? Color(0xFF362C5E) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFF362C5E)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _areaPressed5 ? Colors.white : Color(0xFF362C5E),
                                // 2
                                color: _areaPressed5 ? Color(0xFF362C5E) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFF362C5E)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _areaPressed6 ? Colors.white : Color(0xFF362C5E),
                                // 2
                                color: _areaPressed6 ? Color(0xFF362C5E) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFF362C5E)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _areaPressed7 ? Colors.white : Color(0xFF362C5E),
                                // 2
                                color: _areaPressed7 ? Color(0xFF362C5E) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFF362C5E)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed2 ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed2 ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFFFFAD00)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed3 ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed3 ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFFFFAD00)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed4 ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed4 ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFFFFAD00)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed5 ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed5 ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFFFFAD00)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed6 ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed6 ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFFFFAD00)),
                                ),
                          ...
                          Container(
                            child: SizedBox(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0,
                                textColor: _categoryPressed7 ? Colors.white : Color(0xFFFFAD00),
                                // 2
                                color: _categoryPressed7 ? Color(0xFFFFAD00) : Colors.white,
                                shape: RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(20.0),
                                  side: BorderSide(color: Color(0xFFFFAD00)),
                                ),
